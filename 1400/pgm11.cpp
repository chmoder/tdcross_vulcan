...
{ char letter;
  int counter=0;
  int x=0;
while (counter<=0)  //loop to get number of char to convert
{
cout<<"Please enter the number of charecters you would like to translate to morris code.";
cin>>counter;
}
while (x<counter)  //loop to run operations user defined number of times
{
x++;
cout<<"Please enter charecter #"<<x<<" for me to translate to morris code:";
cin>>letter;
switch (letter)
{ 
  case 'A': case 'a': cout<<".-\n"; break;
